...
(* OASIS_START *)
(* DO NOT EDIT (digest: 3119bf4e47f58c4d2b92d2be1ba38029) *)
(*
...
let setup_t =
  {
     ...
     test = [];
     doc = [("iptables", OCamlbuildDocPlugin.doc_build "lib")];
     install = InternalInstallPlugin.install;
     uninstall = InternalInstallPlugin.uninstall;
     clean = [OCamlbuildPlugin.clean];
     clean_test = [];
     clean_doc = [("iptables", OCamlbuildDocPlugin.doc_clean "lib")];
     distclean = [];
     distclean_test = [];
     distclean_doc = [];
     package =
               ...
               Doc
                 ({
                     ...
                     },
                   {
                      ...
                      doc_title = "Iptables documentation";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
               ...
               Executable
                 ({
                     ...
                     },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "iptables";
                           FindlibPackage ("uint.uint64", None);
                   ...
                   {exec_custom = false; exec_main_is = "test_iptables.ml"; })
            ];
     ...
     oasis_version = "0.3.0";
     oasis_digest =
       Some "\247\203\225\025\027\140\139/\162!\153-\249e\136\129";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
